...
const TermsOfService = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-900 dark:to-slate-800 pt-24 pb-16 px-4">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="space-y-8">
          <Card className="bg-white dark:bg-slate-800 border-0 shadow-lg">
            ...
            <CardContent className="text-slate-600 dark:text-slate-400 space-y-4">
              <p>
                By accessing and using GlobalConnect's services, you accept and agree to be bound by 
        ...
        <div className="mt-12 text-center">
          <p className="text-slate-600 dark:text-slate-400">
            Last updated: March 2024 | Questions? Contact us at legal@globalconnect.com
          </p>
        </div>
      </div>
    </div>
