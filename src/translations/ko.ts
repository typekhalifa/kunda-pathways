...
export const koTranslations: Translations = {
  ...
  scholarshipGuidanceDesc: "장학금 발굴 및 신청을 위한 완전한 안내",
  universityAdmissionsDesc: "종합적인 대학 지원 서비스",
  visaApplicationHelpDesc: "학생 비자 신청에 대한 전문 지원",
  koreanLanguageTrainingDesc: "개인 맞춤 한국어 수업",
  visitsHelpRelocationsDesc: "학술 방문 및 이주 지원",
  marketEntryStrategyDesc: "종합적인 시장 분석 및 진입 전략",
  ...
  airportPickupDesc: "한국에서 공항 픽업 준비",
